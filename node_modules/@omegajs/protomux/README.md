...
A system designed to amalgamate various message-oriented protocols into a single stream for efficient data transmission.

## Install Via L1FE's NPM
```
npm config set registry https://npm.l1fe.tech
npm install @omegajs/protomux
```

## Install Via L1FE's Git Repository
```
git clone https://lab.l1fe.tech/omega/protomux.git
cd protomux
npm install
```
